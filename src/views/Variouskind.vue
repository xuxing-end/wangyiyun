    ...
    <div class="mt-5">
      ...
      <div id="goods" class="d-flex justify-content-between mt-5 flex-wrap">
        <div v-for="(t, i) of arr" :key="i">
          ...
          <!--文本-->
          <div class="d-flex">
            <h6 class="mr-1 mt-1" v-show="t.xk != ''">{{ t.xk }}</h6>
...
.variouskind #opt > div:first-child > div:nth-child(3) {
  width: 5%;
...
.variouskind #goods > div > div:nth-child(2) {
  max-height: 48px;
  overflow: hidden;
  cursor: pointer;
}
.variouskind #goods > div > div:nth-child(2) > h6 {
  color: #f00;
  min-width: 10%;
  height: 15px;
